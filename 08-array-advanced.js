...
let arraySlice =numArray.slice(3);  //start remove and print end index
console.log(arraySlice);
const sliceElements = numArray.slice(1, 5); //start and end index print 
...
console.log(list);
console.log(splice3);
// deleting to start and end number
...
console.log("===========insert the second position of element ==============");
